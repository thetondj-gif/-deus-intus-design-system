...
This repository is a public, reusable Open Design / Claude Design-style design-system package for Deus Intus. It exists so Open Design, Codex, OpenCode, Claude-style agents, and future design tools can read a stable brand source without needing access to the private Deus Intus application repositories.
...
| :--- | :--- |
| `open-design-system.md` | High-level Deus Intus brand and design reference. |
...
## How to use with Open Design

Use the raw GitHub URL when connecting this design system to Open Design:

```text
https://raw.githubusercontent.com/thetondj-gif/-deus-intus-design-system/main/open-design-system.md
```

For fuller package-aware tools, point to the repository root:
